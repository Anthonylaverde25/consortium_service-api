...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference("UserProfile.count") do
      post user_profiles_url, params: { user_profile: { branch_id: @user_profile.branch_id, user_id: @user_profile.user_id } }, as: :json
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { branch_id: @user_profile.branch_id, user_id: @user_profile.user_id } }, as: :json
    assert_response :success
  end
